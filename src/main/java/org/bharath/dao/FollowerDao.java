...
public class FollowerDao {
    private static FollowerDao followerDao_ = null;
    private static Connection connection_ = null;

    private FollowerDao(Connection connection){
    ...
    public boolean followUser(int userId, int followerId){
        ...
        if(isFollowing){
            Main.LOGGER.warning(String.format("You are already following %d user_id", followerId));
            return false;
        }
        ...
        if(!isFollowerExits){
            Main.LOGGER.warning("Follower id is invalid");
            return false;
        }
        ...
        try {
            ...
            Main.LOGGER.info("Added the record to the follower table");
            return true;
    ...
    public List<Users> listAllFollowedUsers(int userId){
        ...
        if(!isUserIdExits){
            Main.LOGGER.warning("You're user id is not valid!");
        ...
        if(usersList.isEmpty()){
            Main.LOGGER.warning("There were no users you are following");
            return null;
        }

        Main.LOGGER.info("Successfully retrieved the following users list");
        return usersList;
    }
    ...
    public List<Users> listAllNotFollowedUsers(int userId){
        ...
        if(followedUserList == null){
            Main.LOGGER.warning("No followers were added for the user so far");
        ...
        Main.LOGGER.info("Successfully retrieved all the non followed users list");
        return allUsersInSocialMedia;
    }
    ...
    public List<Users> listOfAllUsersFollowingYou(int userId){
        ...
        if(usersList.isEmpty()){
            Main.LOGGER.warning("There were no followers following you");
            return null;
        }

        Main.LOGGER.info("Successfully retrieved the followers list");
        return usersList;
    }
    ...
    public boolean unFollowUser(int userId, int unFollowId){
        ...
        if(!isFollowingUserId){
            Main.LOGGER.warning(String.format("The User Id %d is not following %d user_id", userId, unFollowId));
            return false;
        }
        ...
        try{
            ...
            Main.LOGGER.info("Successfully removed the record from the follower table");
            return true;
        }catch(SQLException e){
            Main.LOGGER.severe(e.toString());
            return false;
