...
public class CommentDao {
    private static CommentDao commentDao_ = null;
    ...
    public boolean deleteAllCommentsForThePost(int postId){
        ...
        if(commentList == null){
            Main.LOGGER.info("No comments to delete for deleting the post");
            return true;
        }
        ...
        try {
            ...
            Main.LOGGER.info("Comments deleted Successfully!.");
            return true;
    ...
    public boolean deleteAllCommentsForTheUser(int userId){
        ...
        try {
            ...
            Main.LOGGER.info("Successfully deleted the comments for the user");
            return true;
        } catch (SQLException e) {
            Main.LOGGER.severe(e.toString());
            return false;
    ...
    public boolean commentThePost(int userId, int postId, String commentText){
        try {
            ...
            Main.LOGGER.info("Successfully added the comment to the post id: " + postId);
            return true;
        } catch (SQLException e) {
            Main.LOGGER.severe(e.toString());
            return false;
    ...
    public List<Comment> getAllCommentsForThePost(int postId){
        ...
        try {
            ...
            if(commentList.isEmpty()){
                Main.LOGGER.warning("There was no comments for the post with post id: " + postId);
                Main.CUSTOM_USER_INPUT.printSeparatorLine();
                return null;
            }

            Main.LOGGER.info("Successfully fetched all the comments for the post with post id: " + postId);
            Main.CUSTOM_USER_INPUT.printSeparatorLine();
            return commentList;
        } catch (SQLException e) {
            Main.LOGGER.severe(e.toString());
